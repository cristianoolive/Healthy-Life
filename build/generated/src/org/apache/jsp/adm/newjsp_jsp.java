...
public final class newjsp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>Criar campeonato</title>\n");
      ...
      out.write("                    <h3><b>Criar campeonato</b></h3>\n");
      out.write("                    <h5 class=\"help-block\">Preencha os campos abaixo com seus dados do seu campeonato. Campos com <label class=\"asterisco\">*</label> são obrigatórios.</h5>\n");
      out.write("\n");
      out.write("                    <div class=\"text-center\">\n");
      out.write("                        <h4><b>Adicionar uma foto</b></h4>\n");
      out.write("                        <!-- Icone -->\n");
      out.write("                        <img src=\"../imagens/championship-icon.png\" class=\"avatar img-circle img-thumbnail\" alt=\"avatar\" width=\"150\" style=\"margin-bottom: 16px\" id=\"campeonato\">\n");
      ...
      out.write("                                <label>Nome do Campeonato</label><label class=\"asterisco\">*</label>\n");
      out.write("                                <input type=\"text\" class=\"form-control\" id=\"nome\" placeholder=\"Nome\" title=\"Informe o nome do campeonato\">\n");
      out.write("                            </div>\n");
      out.write("\n");
      out.write("                            <div class=\"col-xs-12\">\n");
      out.write("                                <!-- Box de Descrição -->\n");
      out.write("                                <label for=\"comment\">Descrição</label><label class=\"asterisco\">*</label>\n");
      out.write("                                <textarea class=\"form-control\" rows=\"3\" id=\"descricao\" placeholder=\"Descrição sobre o campeonato: fale sobre o time, os jogadores...\"></textarea>\n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <div class=\"col-xs-6\">\n");
      out.write("                            <!-- Combo-box de Modalidade -->\n");
      out.write("                            <label>Modalidade</label><label class=\"asterisco\">*</label>\n");
      out.write("                            <select class=\"form-control\" id=\"modalidade\">\n");
      out.write("                                <option>Selecione uma modalidade...</option>\n");
      out.write("                                <option>Basquete</option>\n");
      out.write("                                <option>Futebol</option>\n");
      out.write("                                <option>Vôlei</option>\n");
      out.write("                            </select>\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <div class=\"col-xs-6\">\n");
      ...
      out.write("                                <option>Mata-mata</option>\n");
      out.write("                                <option>Campeonato</option>\n");
      out.write("                            </select>\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <div class=\"col-xs-6\">\n");
      out.write("                            <!-- Caixa de Texto da Data de Início -->\n");
      out.write("                            <label>Data de Início</label><label class=\"asterisco\">*</label>\n");
      out.write("                            <input type=\"date\" class=\"form-control datas\" placeholder=\"DD/MM/AAAA\" id=\"dataInicio\">\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <div class=\"col-xs-6\">\n");
      out.write("                            <label>Data de Fim</label>\n");
      out.write("                            <input type=\"date\" class=\"form-control datas\" placeholder=\"DD/MM/AAAA\" id=\"dataFim\">\n");
      out.write("                        </div>\n");
      out.write("\n");
      out.write("                        <div class=\"col-xs-12\">\n");
      ...
      out.write("    var fotopreview = document.getElementById('campeonato');\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("    var descricao = document.getElementById(\"descricao\").value;\n");
      out.write("    var modalidade = document.getElementById(\"modalidade\").value;\n");
      out.write("    var classificacao = document.getElementById(\"classificacao\").value;\n");
      out.write("    var dataInicio = document.getElementById(\"dataInicio\").value;\n");
      out.write("    var dataFim = document.getElementById(\"dataFim\").value;\n");
      out.write("\n");
      out.write("    if (!isEmpty(nome) && !isEmpty(descricao) && !isEmpty(modalidade) && !isEmpty(classificacao) && !isEmpty(dataInicio) && !isEmpty(dataFim)) {\n");
      out.write("        adicionar(nome, descricao, modalidade, classificacao, dataInicio, dataFim);\n");
      out.write("    } else {\n");
      ...
      out.write("}\n");
      out.write("function adicionar(nome, descricao, modalidade, classificacao, dataInicio, dataFim){\n");
      out.write("    var id = firebase.auth().currentUser.uid;\n");
      out.write("    var uid = gerarUid();\n");
      out.write("    firebase.database().ref().child('campeonato/' + uid).set({\n");
      out.write("        nome: nome,\n");
      out.write("        descricao: descricao,\n");
      out.write("        campeonatoId: uid,\n");
      out.write("        modalidade: modalidade,\n");
      out.write("        classificacao: classificacao,\n");
      out.write("        dataInicio: dataInicio,\n");
      out.write("        dataFim: dataFim,\n");
      out.write("        idGerente : id\n");
      out.write("    });\n");
      out.write("\n");
      out.write("    firebase.storage().ref('Regras/'+id).child(nome).put(regras).then(snapshot => {\n");
      out.write("        console.log(\"snapshot\", snapshot);\n");
      out.write("        firebase.storage().ref('Regras').child(nome).getDownloadURL().then(url => {\n");
      ...
      out.write("\n");
      out.write("        firebase.storage().ref('Campeonato/'+id).child(nome).putString(base64, 'base64', {contentType: 'image/png'}).then(snapshot => {\n");
      out.write("            console.log('snapshot', snapshot);\n");
