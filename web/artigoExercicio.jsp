    ...
    <body>
        <jsp:include page="cabecalho.jsp"></jsp:include>
            ...
            <div id="caminho" class="container-fluid">
                ...
                >
                <button id="btnCaminho" type="button" class="btn text-dark"><a class="font-weight-bold" href="exercicio.jsp"style="color: black; font-size: 11px">EXERCÍCIOS FÍSICOS</a></button>
            </div>
            ...
            <script>
                ...
                function adicionarPrevia(informacao, id) {
                    ...
                    if (informacao.classificacao == "Exercícios físicos" && variavel == artigoId) {
